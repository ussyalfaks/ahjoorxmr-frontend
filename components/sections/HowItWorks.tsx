...
export default function HowItWorks() {
  return (
    <section id="how" className="bg-[var(--bg2)] px-6 py-24 text-center">
      <div className="max-w-[480px] mx-auto">
        ...
        <p className="text-[var(--muted)] text-[16px] mb-[52px]">
        ...
        <ol className="flex flex-col items-center gap-0 mb-12 list-none" aria-label="Steps to get started">
          {steps.map((s, i) => (
            <li key={s.title} className="flex flex-col items-center w-full">
              <div
                className="flex items-center gap-[18px] bg-[var(--card)] border border-[var(--border)] rounded-[16px] px-7 py-[22px] w-full text-left transition-all duration-200 hover:border-[rgba(108,92,231,0.45)] hover:translate-x-1"
              ...
              >
                <div
                  className="w-10 h-10 flex-shrink-0 rounded-full flex items-center justify-center font-['Sora'] font-bold text-[15px] text-[var(--text)]"
                  style={{
                ...
                <div className="flex-1">
                  <h3 className="font-['Sora'] text-[16px] font-bold text-[var(--text)] mb-1">
                    {s.title}
                  </h3>
                  <p className="text-[14px] text-[var(--muted)]">{s.desc}</p>
                </div>
              </div>
